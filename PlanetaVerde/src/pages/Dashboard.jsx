...
const gerarPDF = () => {
  const elemento = document.querySelector('.dashboard-main');
  const opt = {
    margin: 0.2,
    filename: `dashboard_${new Date().toLocaleDateString('pt-BR')}.pdf`,
    ...
    <div className="dashboard-container">
      ...
      <main className="dashboard-main">
        ...
        <div className="filtro-container">
          ...
          <button className="botao-pdf" onClick={gerarPDF}>
            Salvar como PDF
          </button>
        </div>
